...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlertmanagerApi.AlertApi();
  });
  ...
  describe('AlertApi', function() {
    ...
    describe('postAlerts', function() {
      it('should call postAlerts successfully', function(done) {
        //uncomment below and update the code to test postAlerts
        //instance.postAlerts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
