...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlertmanagerApi.PostableSilence();
  });
  ...
  describe('PostableSilence', function() {
    it('should create an instance of PostableSilence', function() {
      // uncomment below and update the code to test PostableSilence
      //var instane = new AlertmanagerApi.PostableSilence();
      //expect(instance).to.be.a(AlertmanagerApi.PostableSilence);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new AlertmanagerApi.PostableSilence();
