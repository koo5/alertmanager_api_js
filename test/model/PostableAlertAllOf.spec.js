...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlertmanagerApi.PostableAlertAllOf();
  });
  ...
  describe('PostableAlertAllOf', function() {
    it('should create an instance of PostableAlertAllOf', function() {
      // uncomment below and update the code to test PostableAlertAllOf
      //var instane = new AlertmanagerApi.PostableAlertAllOf();
      //expect(instance).to.be.a(AlertmanagerApi.PostableAlertAllOf);
    });
    ...
    it('should have the property startsAt (base name: "startsAt")', function() {
      ...
      //var instance = new AlertmanagerApi.PostableAlertAllOf();
