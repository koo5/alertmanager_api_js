...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlertmanagerApi.AlertGroup();
  });
  ...
  describe('AlertGroup', function() {
    it('should create an instance of AlertGroup', function() {
      // uncomment below and update the code to test AlertGroup
      //var instane = new AlertmanagerApi.AlertGroup();
      //expect(instance).to.be.a(AlertmanagerApi.AlertGroup);
    });

    it('should have the property labels (base name: "labels")', function() {
      // uncomment below and update the code to test the property labels
      //var instance = new AlertmanagerApi.AlertGroup();
