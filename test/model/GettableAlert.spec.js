...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlertmanagerApi.GettableAlert();
  });
  ...
  describe('GettableAlert', function() {
    it('should create an instance of GettableAlert', function() {
      // uncomment below and update the code to test GettableAlert
      //var instane = new AlertmanagerApi.GettableAlert();
      //expect(instance).to.be.a(AlertmanagerApi.GettableAlert);
    });
    ...
    it('should have the property annotations (base name: "annotations")', function() {
      ...
      //var instance = new AlertmanagerApi.GettableAlert();
